...
const ArrowUp = () => {
    return (
        ...
        <polyline data-accordion-icon-shape="" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" fill="none" fillRule="evenodd" points="15 7.72 8.5 1.13 2 7.72">
